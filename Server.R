...
#      cex<-rep(1,6)
      ...
      par (col=iro[2])
      points(0.02,0.85)
      text(0.06,0.85,labels=paste(names(cc() )[3],"Plurality"),pos=4, col = iro_opaque[2])
      par (col=iro[3])
      points(0.02,0.8)
      text(0.06,0.8,labels=paste(names(cc() )[4],"Plurality"),pos=4, col = iro_opaque[3])
      par (col=iro[4])
      points(0.02,0.75)
...
#    cex<-c(0.9,1.2,1.0,1.0,1.3,1.0)
    ...
    par (col=iro[2])
    points(0.02,0.85)
    text(0.06,0.85,labels=paste(names(saved)[3],"Plurality"),pos=4, col = iro_opaque[2])
    par (col=iro[3])
    points(0.02,0.8)
    text(0.06,0.8,labels=paste(names(saved)[4],"Plurality"),pos=4, col = iro_opaque[3])
    par (col=iro[4])
    points(0.02,0.75)
